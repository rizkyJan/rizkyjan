  ...
  return (
    <div className="w-full bg-zinc-950 text-zinc-300 font-sans selection:bg-emerald-500/30 relative">
      ...
      <div className="hidden md:flex fixed bottom-0 left-8 xl:left-12 flex-col items-center gap-6 z-50">
        <a
          href="https://github.com/rizkyJan"
          target="_blank"
          rel="noreferrer"
          className="text-zinc-400 hover:text-emerald-400 hover:-translate-y-1 transition-all duration-300"
          aria-label="GitHub"
        >
        ...
        <a
          href="https://instagram.com/rzkyja"
          target="_blank"
          rel="noreferrer"
          className="text-zinc-400 hover:text-emerald-400 hover:-translate-y-1 transition-all duration-300"
        ...
        <a
          href="https://www.linkedin.com/in/riski-januar-0a9586320/"
          target="_blank"
          rel="noreferrer"
          className="text-zinc-400 hover:text-emerald-400 hover:-translate-y-1 transition-all duration-300"
          aria-label="LinkedIn"
      ...
      <section className="relative min-h-[95vh] flex flex-col items-center justify-center text-center px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
          ...
          >
            START EXPLORING
            <span className="ml-2 group-hover:translate-y-1 transition-transform duration-200">
              &darr;
            </span>
          </a>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-7 space-y-6">
            ...
            <p className="text-zinc-400 leading-relaxed text-lg">
              Fresh Graduate S1 Teknik Informatika yang berdomisili di
              Karanganyar. Memiliki ketertarikan kuat dalam pengembangan
              aplikasi web terpadu, infrastruktur server, dan otomatisasi
              sistem.
            </p>
            <p className="text-zinc-400 leading-relaxed text-lg">
              Berpengalaman dalam merancang perangkat lunak secara{" "}
              <span className="text-zinc-200">end-to-end</span>, mulai dari
              full-stack development, eksplorasi local hosting menggunakan STB
              dengan Os Debian, manajemen VPS (Linux/Cloud), hingga membangun
      ...
      <section
        id="skills"
        className="relative bg-zinc-900/30 border-y border-zinc-800/50 overflow-hidden"
      >
        ...
        <div className="max-w-6xl mx-auto px-6 py-32 relative z-10">
          <div className="flex flex-col items-center mb-16 text-center">
            <span className="text-emerald-500 font-mono text-sm tracking-widest uppercase mb-3">
              Arsenal
            </span>
            ...
            <div className="bg-zinc-950/50 backdrop-blur-sm border border-zinc-800/50 p-8 rounded-xl hover:border-emerald-500/30 transition-colors duration-300 group">
              ...
              <div className="flex flex-wrap gap-2.5">
                {[
                  ...
                  <span
                    key={skill}
                    className="px-3 py-1.5 bg-zinc-900 border border-zinc-800 text-zinc-300 text-xs font-mono rounded-md hover:text-emerald-400 hover:border-emerald-500/30 transition-colors"
                  >
                    {skill}
                  </span>
                ))}
