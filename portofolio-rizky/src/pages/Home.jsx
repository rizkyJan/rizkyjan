  ...
  return (
    <div className="w-full bg-zinc-950 text-zinc-300 font-sans selection:bg-emerald-500/30 relative">
      ...
      <div className="hidden md:flex fixed bottom-0 left-8 xl:left-12 flex-col items-center gap-6 z-50">
        ...
        <a href="www.linkedin.com/in/riski-januar-0a9586320" target="_blank" rel="noreferrer" className="text-zinc-400 hover:text-emerald-400 hover:-translate-y-1 transition-all duration-300" aria-label="LinkedIn">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-7 space-y-6">
            ...
            <p className="text-zinc-400 leading-relaxed text-lg">
              Mahasiswa Teknik Informatika di Universitas Muhammadiyah Surakarta
            ...
            <p className="text-zinc-400 leading-relaxed text-lg">
              ...
              menggunakan STB, manajemen VPS (Linux/Cloud), hingga membangun
